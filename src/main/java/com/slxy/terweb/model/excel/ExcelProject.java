...
//    导出
    ...
    public ExcelProject(String psn, String pname, String tsn, String tname, String pmember, String pcondition, String pgrad, String pkind, BigDecimal pmoney, String pstatime, String pendtime, String contractType, String cname, String dnane, String tedubackground, String jobTitle, String premarks) {
        Psn = psn;
        Pname = pname;
        Tsn = tsn;
        this.tname = tname;
...
//    导入excel
    ...
    public ExcelProject(String psn, String pname, String tsn, String pmember, String pcondition, String pgrad, String pkind, BigDecimal pmoney, String pstatime, String pendtime, String contractType, String premarks) {
        Psn = psn;
        Pname = pname;
        Tsn = tsn;
        Pmember = pmember;
