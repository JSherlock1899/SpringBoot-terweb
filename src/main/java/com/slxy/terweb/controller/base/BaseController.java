package com.slxy.terweb.controller.base;
...
public class BaseController<T> {
    ...
    public static String[] yearsArr = {"2015-1-1","2016-1-1","2017-1-1","2018-1-1","2019-1-1","2020-1-1"};

    public static final String PROJECT = "findProject";
    public static final String PAPER = "findPaper";
    public static final String HONOR = "findHonor";
    public static final String PATENT = "findPatent";
    public static final String OTHER = "findOther";
