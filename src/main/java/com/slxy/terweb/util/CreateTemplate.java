...
public class CreateTemplate {
    ...
    public  void createExcel(HttpServletResponse response, String name) {
        // 获取解析xml文件路径
//        URL url = CreateTemplate.class.getClassLoader().getResource("classpath:/excelTemplate/" + name + ".xml");
        try {
            File file = ResourceUtils.getFile(ResourceUtils.CLASSPATH_URL_PREFIX+ "excelTemplate/" + name + ".xml");
