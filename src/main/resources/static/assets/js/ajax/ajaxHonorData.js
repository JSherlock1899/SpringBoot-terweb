...
function check() {
    var check = checkHname('Hname','请按要求输入荣誉名称') || checkHwinner('Hwinner','请按要求输入获奖者')
    return check;
}
...
function initFileInput(ctrlName) {
    ...
    var Hname = undefined ? '' : $('#Hname').val();
    var Hsn = $('#Hsn').val();
    control.fileinput({
        language: 'zh', //设置语言
        uploadUrl: "/file/upload?model=honor&name=" + Hname + "&majorkey=" + Hsn, //上传的地址
