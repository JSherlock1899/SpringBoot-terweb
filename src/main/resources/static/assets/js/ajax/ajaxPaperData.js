...
$(document).on("click",".alter",function(e,url){
    ...
    $("#corrAuthor").attr("value",$(this).closest("tr").find(".corrAuthor").text());
...
// 	}
	...
	// function checkcorrAuthor(id,info){
	...
	// function check() {
	// 	var check = checkPasearchnum('Pasearchnum','请按要求输入查询编号') ;
	// 	return check;
    // }
...
function initFileInput(ctrlName) {
    ...
    control.fileinput({
        language: 'zh', //设置语言
        uploadUrl: "/file/upload?model=paper&name=" + Paname + "&majorkey=" + Pasearchnum, //上传的地址
