...
$(document).on("change","#Pkind",function(){
	...
	// 	var uValue = undefined ? '':document.getElementById(id).value
	...
	function check() {
		var check =  checkPmoney('Pmoney','请按要求输入项目经费');
		return check;
    }
...
function initFileInput(ctrlName) {
    ...
    var Pname = undefined ? '' :$('#Pname').val();
    var Psn = $('#Psn').val();
    control.fileinput({
        language: 'zh', //设置语言
        uploadUrl: "/file/upload?model=project&name=" + Pname + "&majorkey=" + Psn, //上传的地址
